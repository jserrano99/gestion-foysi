...
//			'cdn_language_by_locale' => false
        ...
        $this->columnBuilder
                ...
                ->add('descripcion', Column::class, array('title' => 'Descripcion', 'width' => '300px', 'searchable' => true,'class_name' => 'centrado'))
                ->add('importeUnitario', NumberColumn::class, array('title' => 'Base Imponible','class_name' => 'centrado',
